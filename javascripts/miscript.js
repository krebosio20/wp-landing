...
$(document).ready(function(){
  ...
  $('.menubar-responsive #modal ul li a').click(function(){
    $( '#cerrar-modal' ).removeAttr("checked");
    $( '#mostrar-modal' ).attr("checked",false);
    $( '.mostrar-modal' ).css("display","block");
    $( '.cerrar-modal' ).css("display","none");
  });
});
